describe('Login Page', () => {
    ...
    it('Checks for login components and functionality', () => {
        cy.get('[data-testID="userName-input"]').should('exist').as('userName').type('Banjamin')
        .get('@userName').should('have.value','Banjamin')
        cy.get('[data-testID="password-input"]').should('exist').as('password').type('password')
